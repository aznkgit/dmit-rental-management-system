...
namespace RentalManagementSystem.DAL;

public partial class StarTed2024OctContext : DbContext
{
    public StarTed2024OctContext(DbContextOptions<StarTed2024OctContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AssessmentTypeID).HasName("PK__Assessme__3368D751DACDE006");
        });
        ...
        {
            entity.HasKey(e => e.CampusVenueID).HasName("PK__CampusVe__5902141F1E95AE11");
        });
        ...
        {
            entity.HasKey(e => e.RentalTypeID).HasName("PK__RentalTy__DECD558EDAB5A8D5");
        });
        ...
        {
            entity.HasKey(e => e.RoleID).HasName("PK__Roles__8AFACE3A561EEDC1");
        });
